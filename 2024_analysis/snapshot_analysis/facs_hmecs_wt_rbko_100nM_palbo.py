...
filelist = glob(path.join(dirname,'07-01-2024 HMEC Geminin-mChe_HMEC WT_100nM Palbo 5 days.fcs'))
...
filelist = glob(path.join(dirname,'HMECs RBKO mCh-Geminin 100nM Palbociclib Fixed Hoechst SE647.fcs'))
df = FCMeasurement(ID='Test Sample', datafile=filelist[0]).data
