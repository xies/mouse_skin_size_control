...
sb.regplot(data=df,x='G1 volume interpolated',y='SG2 grown interpolated',fit_reg=True,ci=None)
plot_bin_means(df['G1 volume interpolated'],df['SG2 grown interpolated'],g1_vol_bins)
