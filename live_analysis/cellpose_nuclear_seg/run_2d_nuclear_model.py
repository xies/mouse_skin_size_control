...
dirname = '/Users/xies/OneDrive - Stanford/Shuyuan Hepatocytes/012621 Nusse Fucci hepatocytes Rpb1CTD_SX'

diameter = 30 #27 OK for 1.5x BE basal cells at 1.4 zoomin
cellprob_threshold = -0.1

filelist = glob(path.join(dirname,'*/Default/*channel000*.tif'))
