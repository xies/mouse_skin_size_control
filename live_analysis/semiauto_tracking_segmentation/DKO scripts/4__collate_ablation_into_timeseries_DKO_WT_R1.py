...
dirnames['DKOM1_WT_R1'] = '/Volumes/T7/11-07-2023 DKO/M3 p107homo Rbfl/Right ear/Post Ethanol/R1/'

dx = {}
dx['DKOM1_WT_R1'] = 0.2919921875
dz = {}
dz['DKOM1_WT_R1'] = 0.7

mouse = {'DKOM1_R1':'DKOM1','DKOM1_WT_R1':'DKOM1'}

pairs = {'DKOM1':'Pair 1'}
beginning = {'DKOM1_R1':10,'DKOM1_WT_R1':10}
...
for name,dirname in dirnames.items():
    ...
    for mode in ['curated']:
        ...
        pathdict['H2B'] = path.join(dirname,'master_stack/B.tif')
