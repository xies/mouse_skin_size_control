...
for t,im in tqdm(enumerate(imstack)):
    ...
    io.imsave(path.join(dirname,f'heightmaps/t{1}.tif'),heightmap.astype(np.int8))
    ...
    io.imsave(path.join(dirname,f'height_image/t{t}.tif'), height_image.astype(np.int16))
