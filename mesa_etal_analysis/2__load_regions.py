...
r2 = pd.read_pickle('/Users/xies/Box/Mouse/Skin/Mesa et al/W-R2/tracked_cells/dataframe.pkl')
...
with open('/Users/xies/Box/Mouse/Skin/Mesa et al/W-R1/tracked_cells/collated_manual.pkl','rb') as f:
    c1 = pkl.load(f)
with open('/Users/xies/Box/Mouse/Skin/Mesa et al/W-R2/tracked_cells/collated_manual.pkl','rb') as f:
    c2 = pkl.load(f)
